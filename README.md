...
6. **[TK-main energy and blood glucose detection]** = Blood glucose detection based on Teager-Kaiser main energy of photoacoustic signal(Here is the author)  
>[[REF] Takeda H, Farsiu S, Milanfar P. Kernel regression for image processing and reconstruction[J]. 2006](https://pubmed.ncbi.nlm.nih.gov/34144363/)  
>[[ToolBox] ValoMC toolbox + k-Wave toolbox(For simulation)]
>[[ToolBox] Time-Frequency Toolbox-For Use with Matlab]
